...
import 'package:hakime_doctor_et/controllers/doctor_controllers/dappointmentcontroller.dart';
        ...
        title: SizedBox(
            ...
            child: Query(
              options: QueryOptions(
                document: gql(Myquery.chat_user_profile),
                variables: {"id": Get.arguments},
              ),
              builder: (result, {fetchMore, refetch}) {
                var chat_header = result.data!["users_by_pk"];
          ...
          children: [
            Expanded(
              ...
              options: SubscriptionOptions(
                ...
                variables: {
                  "doctor_id": Get.find<SplashController>().prefs.getInt("id"),
                  "user_id": Get.arguments
                },
              ),
              builder: (result) {
            ...
            Obx(
              () => Visibility(
                  visible: Get.find<dappointmentcontroller>()
                      .is_sending_message
                      .value,
            ...
            Mutation(
              options: MutationOptions(
                ...
                onCompleted: (data) {
                  Get.find<dappointmentcontroller>().is_sending_message.value =
                      false;
                },
              ),
                    ...
                    children: [
                      ...
                      IconButton(
                          onPressed: () {
                            Get.find<dappointmentcontroller>()
                                .is_emoje_show
                                .value = Get.find<dappointmentcontroller>()
                                    .is_emoje_show
                                    .value
                                ? false
                                : true;
            ...
            Obx(() => Offstage(
                  offstage:
                      !Get.find<dappointmentcontroller>().is_emoje_show.value,
                  child: SizedBox(
                      height: 250,
                      child: EmojiPicker(
